...
typedef enum {
    ...
    PLAY_FAIL = -1001,
    PLAY_AUDIO_OUTPUT_NOT_READY= -1002,
    PLAY_FUNCTION_NOT_IMPLEMENTED= -1003,
    PLAY_ALREADY_PAUSED = -1004,
    PLAY_ALREADY_PLAYING = -1005,
    PLAY_ALREADY_STOPPED = -1006,
    PLAY_CANT_INIT_AUDIO = -1007,
    PLAY_CANT_INIT_STREAM = -1008,
    PLAY_STREAM_NOT_INIT = -1009
